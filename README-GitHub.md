...
```bash
# 1. 克隆代码
git clone https://github.com/TAN-GOOD/AI-MCP-MQTT.git
cd AI-MCP-MQTT
...
```bash
curl -fsSL https://raw.githubusercontent.com/TAN-GOOD/AI-MCP-MQTT/master/install.sh | bash
```
...
4. 名称填 `xiaozhi-mcp`
5. 选择 **从服务器路径加载**
6. 路径填 `/opt/AI-MCP-MQTT/docker-compose.yml`
7. 点击 **确认**
...
1. SSH 登录服务器执行 `cd /opt/AI-MCP-MQTT && git pull`
